...
ا<a href="https://github.com/Gozargah/Marzban">Marzban Templates<a>
...
```sh
sudo wget -N -P /var/lib/marzban/templates/subscription/  https://raw.githubusercontent.com/ninjastrikers/marzban-sub/main/index.html
```
